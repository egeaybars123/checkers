...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "egeaybars123.checkers.checkers.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "egeaybars123.checkers.checkers.MsgCreateGameResponse")
}
...
var fileDescriptor_b89f7ca8d0309536 = []byte{
	...
	0x4d, 0x4f, 0x4d, 0xac, 0x4c, 0x4a, 0x2c, 0x2a, 0x36, 0x34, 0x32, 0xd6, 0x83, 0xc9, 0xc3, 0x19,
	...
	0x0d, 0x1c, 0xf0, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xb8, 0x3e, 0x4a, 0x55, 0x8d, 0x01,
	0x00, 0x00,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/egeaybars123.checkers.checkers.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/egeaybars123.checkers.checkers.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "egeaybars123.checkers.checkers.Msg",
